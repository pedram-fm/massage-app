...
interface TodoBoardProps {
  ...
  /** Extra className for the inner container div */
  containerClassName?: string;
  /** Optional header slot rendered above the title */
  headerSlot?: React.ReactNode;
  /** Override styling on the title h1 */
...
export function TodoBoard({
  ...
  containerClassName = "",
  headerSlot,
  titleClassName = "text-3xl font-bold text-[color:var(--brand)]",
}: TodoBoardProps) {
  ...
  return (
    <div className={`min-h-screen ${wrapperClassName}`}>
      <div className={`mx-auto max-w-[1600px] ${containerClassName}`}>
        {/* Header */}
