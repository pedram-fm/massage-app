...
export default function LogsPage() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#f8f1e9_0%,_#f4ebe2_45%,_#efe5db_100%)] px-4 py-10 text-[color:var(--foreground)]">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
        <div className="rounded-3xl border border-[color:var(--surface-muted)] bg-[color:var(--surface)] p-6 shadow-[0_20px_60px_rgba(19,13,8,0.12)]">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              <p className="text-xs uppercase tracking-[0.3em] text-[color:var(--muted-text)]">
                Live Monitor
              </p>
              <h1
